...
static void log_with_timestamp(const char *msg) {
    ...
    std::ofstream log_file("/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/SecRetAddress/SecRetAddress-master-instrumented/test_plugin/trace_plugin.cpp.log", std::ios::app);
...
static inline tree build_const_char_string(int len, const char *str)
{
	...
	TREE_STATIC(cstr) = 1;
    log_with_timestamp(R"JSON({"event":"RETURN","function":"build_const_char_string","func_id":9,"file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/SecRetAddress/SecRetAddress-master-instrumented/test_plugin/plugin.cpp","line":42,"ret_type":"int","expr":"cstr"})JSON");
...
static vec<tree, va_gc> * create_clobbers(std::string clobbers_str){
    ...
    log_with_timestamp(R"JSON({"event":"RETURN","function":"create_clobbers","func_id":8,"file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/SecRetAddress/SecRetAddress-master-instrumented/test_plugin/plugin.cpp","line":65,"ret_type":"int *","expr":"clobbers"})JSON");
...
static tree create_pointer(const char *str){
    ...
    log_with_timestamp(R"JSON({"event":"RETURN","function":"create_pointer","func_id":7,"file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/SecRetAddress/SecRetAddress-master-instrumented/test_plugin/plugin.cpp","line":74,"ret_type":"int","expr":"var"})JSON");
...
static void insert_asm_instr_after(const char *str, vec<tree, va_gc> *inputs, vec<tree, va_gc> *outputs, 
											vec<tree, va_gc> *clobbers, vec<tree, va_gc> *labels, bool _volatile, gimple_stmt_iterator * gsi){
    log_with_timestamp(R"JSON({"event":"FUNC_ENTER","file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/SecRetAddress/SecRetAddress-master-instrumented/test_plugin/plugin.cpp","function":"insert_asm_instr_after","func_id":5,"num_params":7,"start_line":87,"end_line":95,"metrics":{"num_params":7,"call_count":0,"has_recursion":false,"has_loop":false,"has_if":false,"has_switch":false,"has_goto":false,"stmt_count":0},"flags":{"is_method":false,"is_static_method":false,"is_const_method":false,"is_virtual_method":false,"is_variadic":false},"params":[{"name":"str","type":"const char *","is_pointer":true,"is_const":false},{"name":"inputs","type":"int *","is_pointer":true,"is_const":false},{"name":"outputs","type":"int *","is_pointer":true,"is_const":false},{"name":"clobbers","type":"int *","is_pointer":true,"is_const":false},{"name":"labels","type":"int *","is_pointer":true,"is_const":false},{"name":"_volatile","type":"bool","is_pointer":false,"is_const":false},{"name":"gsi","type":"int *","is_pointer":true,"is_const":false}]})JSON");
...
static void instrument_entry(function *fun, tree var){
    log_with_timestamp(R"JSON({"event":"FUNC_ENTER","file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/SecRetAddress/SecRetAddress-master-instrumented/test_plugin/plugin.cpp","function":"instrument_entry","func_id":4,"num_params":2,"start_line":97,"end_line":144,"metrics":{"num_params":2,"call_count":8,"has_recursion":false,"has_loop":false,"has_if":false,"has_switch":false,"has_goto":false,"stmt_count":0},"flags":{"is_method":false,"is_static_method":false,"is_const_method":false,"is_virtual_method":false,"is_variadic":false},"params":[{"name":"fun","type":"int *","is_pointer":true,"is_const":false},{"name":"var","type":"int","is_pointer":false,"is_const":false}]})JSON");
...
static bool to_instrument(function *fun){
	...
	if(local_declarations == NULL) {
	    log_with_timestamp(R"JSON({"event":"RETURN","function":"to_instrument","func_id":2,"file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/SecRetAddress/SecRetAddress-master-instrumented/test_plugin/plugin.cpp","line":180,"ret_type":"bool","expr":"false"})JSON");
    ...
    log_with_timestamp(R"JSON({"event":"RETURN","function":"to_instrument","func_id":2,"file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/SecRetAddress/SecRetAddress-master-instrumented/test_plugin/plugin.cpp","line":189,"ret_type":"bool","expr":"to_instr"})JSON");
    log_with_timestamp(R"JSON({"event":"FUNC_EXIT","function":"to_instrument","func_id":2})JSON");
	return to_instr;
}

static unsigned int instrument_functions(function *fun){
    log_with_timestamp(R"JSON({"event":"FUNC_ENTER","file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/SecRetAddress/SecRetAddress-master-instrumented/test_plugin/plugin.cpp","function":"instrument_functions","func_id":1,"num_params":1,"start_line":192,"end_line":213,"metrics":{"num_params":1,"call_count":8,"has_recursion":false,"has_loop":false,"has_if":true,"has_switch":false,"has_goto":false,"stmt_count":0},"flags":{"is_method":false,"is_static_method":false,"is_const_method":false,"is_virtual_method":false,"is_variadic":false},"params":[{"name":"fun","type":"int *","is_pointer":true,"is_const":false}]})JSON");
	...
	if(!to_instrument(fun)) {
	    log_with_timestamp(R"JSON({"event":"RETURN","function":"instrument_functions","func_id":1,"file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/SecRetAddress/SecRetAddress-master-instrumented/test_plugin/plugin.cpp","line":195,"ret_type":"unsigned int","expr":"0"})JSON");
    ...
    log_with_timestamp(R"JSON({"event":"RETURN","function":"instrument_functions","func_id":1,"file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/SecRetAddress/SecRetAddress-master-instrumented/test_plugin/plugin.cpp","line":212,"ret_type":"unsigned int","expr":"0"})JSON");
    log_with_timestamp(R"JSON({"event":"FUNC_EXIT","function":"instrument_functions","func_id":1})JSON");
	return 0;
}
...
int plugin_init(struct plugin_name_args *plugin_info, struct plugin_gcc_version *version){
    log_with_timestamp(R"JSON({"event":"FUNC_ENTER","file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/SecRetAddress/SecRetAddress-master-instrumented/test_plugin/plugin.cpp","function":"plugin_init","func_id":0,"num_params":2,"start_line":248,"end_line":271,"metrics":{"num_params":2,"call_count":1,"has_recursion":false,"has_loop":false,"has_if":true,"has_switch":false,"has_goto":false,"stmt_count":0},"flags":{"is_method":false,"is_static_method":false,"is_const_method":false,"is_virtual_method":false,"is_variadic":false},"params":[{"name":"plugin_info","type":"struct plugin_name_args *","is_pointer":true,"is_const":false},{"name":"version","type":"struct plugin_gcc_version *","is_pointer":true,"is_const":false}]})JSON");
    ...
    log_with_timestamp(R"JSON({"event":"RETURN","function":"plugin_init","func_id":0,"file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/SecRetAddress/SecRetAddress-master-instrumented/test_plugin/plugin.cpp","line":251,"ret_type":"int","expr":"1"})JSON");
    ...
    log_with_timestamp(R"JSON({"event":"RETURN","function":"plugin_init","func_id":0,"file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/SecRetAddress/SecRetAddress-master-instrumented/test_plugin/plugin.cpp","line":270,"ret_type":"int","expr":"0"})JSON");
    log_with_timestamp(R"JSON({"event":"FUNC_EXIT","function":"plugin_init","func_id":0})JSON");
	return 0;
}
