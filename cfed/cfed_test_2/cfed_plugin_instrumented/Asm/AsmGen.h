...
class AsmGen{
	public:
		...
		static rtx_insn* emitAndRegReg(unsigned int reg1, unsigned int reg2, rtx_insn* attachRtx, basic_block bb, bool after);
		static rtx_insn* emitEorRegInt(unsigned int regNumber, int number, rtx_insn* attachRtx, basic_block bb, bool after);
		static rtx_insn* emitEorRegReg(unsigned int reg1, unsigned int reg2, rtx_insn* attachRtx, basic_block bb, bool after);
		...
		static rtx_insn* emitBeqRegReg(unsigned int reg1, unsigned int reg2, rtx_insn* codeLabel, rtx_insn* attachRtx, basic_block bb, bool after);
		static rtx_insn* emitBne(rtx_insn* codelabel, rtx_insn* attachRtx, basic_block bb, bool after);
		static rtx_insn* emitBneRegInt(unsigned int regNumber, int cmpNumber, rtx_insn* codeLabel, rtx_insn* attachRtx, basic_block bb, bool after);
		static rtx_insn* emitBneRegReg(unsigned int reg1, unsigned int reg2, rtx_insn* codeLabel, rtx_insn* attachRtx, basic_block bb, bool after);
