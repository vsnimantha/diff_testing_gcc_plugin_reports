 ...
 * Emits: AND reg1, reg2
 */
 rtx_insn* AsmGen::emitAndRegReg(unsigned int reg1, unsigned int reg2, rtx_insn* attachRtx, basic_block bb, bool after){
 	rtx regRtx1 = gen_rtx_REG(SImode, reg1);
 	rtx regRtx2 = gen_rtx_REG(SImode, reg2);
 	rtx andR = gen_rtx_AND(SImode, regRtx1, regRtx2);
 	rtx set = gen_movsi(regRtx1, andR);
 	rtx_insn* insn = emitInsn(set, attachRtx, bb, after);
 	return insn;
 }
 ...
 * Emits: EOR reg1, reg2
 */
rtx_insn* AsmGen::emitEorRegReg(unsigned int reg1, unsigned int reg2, rtx_insn* attachRtx, basic_block bb, bool after){
	rtx regRtx1 = gen_rtx_REG(SImode, reg1);
	rtx regRtx2 = gen_rtx_REG(SImode, reg2);
	rtx xorRtx = gen_rtx_XOR(SImode, regRtx1, regRtx2);
	rtx set = gen_movsi(regRtx1, xorRtx);
	rtx_insn* insn = emitInsn(set, attachRtx, bb, after);
	return insn;
}
...
/**
 * Emits:	CMP reg1, reg2
 * 			Beq .codeLabel (ARMv6-M)
 */ 
rtx_insn* AsmGen::emitBeqRegReg(unsigned int reg1, unsigned int reg2, rtx_insn* codeLabel, rtx_insn* attachRtx, basic_block bb, bool after){
	rtx regRtx1 = gen_rtx_REG(SImode, reg1);
	rtx regRtx2 = gen_rtx_REG(SImode, reg2);
	rtx eq = gen_rtx_EQ(SImode, regRtx1, regRtx2);
	rtx ITE = gen_rtx_IF_THEN_ELSE(VOIDmode, eq, gen_rtx_LABEL_REF(VOIDmode, codeLabel), pc_rtx);
 ...
 */
rtx_insn* AsmGen::emitBneRegInt(unsigned int regNumber, int cmpNumber, rtx_insn* codeLabel, rtx_insn* attachRtx, basic_block bb, bool after){
	rtx reg = gen_rtx_REG(SImode, regNumber);
 ...
 * 			BNE .codelabel (ARMV6-M syntax)
 */
rtx_insn* AsmGen::emitBneRegReg(unsigned int reg1, unsigned int reg2, rtx_insn* codeLabel, rtx_insn* attachRtx, basic_block bb, bool after){
	rtx regRtx1 = gen_rtx_REG(SImode, reg1);
	rtx regRtx2 = gen_rtx_REG(SImode, reg2);
	rtx ne = gen_rtx_NE(SImode, regRtx1, regRtx2);
	rtx ITE = gen_rtx_IF_THEN_ELSE(VOIDmode, ne, gen_rtx_LABEL_REF(VOIDmode, codeLabel), pc_rtx);
	rtx_insn* branch = emitInsn(gen_movsi(pc_rtx, ITE), attachRtx, bb, after);
	return branch;
}
