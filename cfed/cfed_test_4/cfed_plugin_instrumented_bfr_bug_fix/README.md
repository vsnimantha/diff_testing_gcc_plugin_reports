...
Possibly need the following packages as well, depending on your Linux setup: libgmp3-dev, gcc-multilib, g++-multilib and linux-libc-dev.
...
CFCSS | r7 & r5 | r11 & r10
RSCFC | r7 & r5 | r11 & r10
ECCA | Not Supported | r11 & r10
SCFC | r7 & r5 & r4 | r11 & r10
YACCA | Not Supported | r11 & r10 & r9
YACCA_Fast | r7 & r5 | r11 & r10 & r9
...
In this section, all available UML diagrams are shown. The different sources for all diagrams are stored in [UML_Diagrams](./UML_Diagrams).

### Class Diagram

![UML class diagram](UML_Diagrams/CFED_Plugin_UMLClass.drawio.svg)
