...
#define EMIT_AFTER true
#define EMIT_BEFORE false
...
class AsmGen{
	public:
		...
		static rtx_insn* emitEorRegReg(unsigned int destReg, unsigned int operand1, unsigned int operand2, rtx_insn* attachRtx, basic_block bb, bool after);
		...
		static rtx_insn* emitBhi(rtx_insn* codeLabel, rtx_insn* attachRtx, basic_block bb, bool after);
		static rtx_insn* emitBlo(rtx_insn* codeLabel, rtx_insn* attachRtx, basic_block bb, bool after);
		static rtx_insn* emitB(rtx_insn* codeLabel, rtx_insn* attachRtx, basic_block bb, bool after);

		static rtx_insn* emitBl(const char* functionName, rtx_insn* attachRtx, bool after);
