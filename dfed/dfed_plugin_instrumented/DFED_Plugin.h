...
#ifndef DFED_PLUGIN_H_
#define DFED_PLUGIN_H_
...
class DFED_PLUGIN : public rtl_opt_pass{
	public:
		DFED_PLUGIN(gcc::context *ctxt, struct plugin_argument *arguments, int argcounter);

		bool gate(function *fun);

		unsigned int execute(function *fun);

		static const char* findArgumentValue(const char* key, const struct plugin_argument *args, int argc);
	...
	private:
		...
		void implementDetectionTechnique();
