...
static void log_with_timestamp(const char *msg) {
    ...
    std::ofstream log_file("/home/nimantha/FIRES/dfed_plugin_instrumented/trace_DFED_Plugin_Main.cpp.log", std::ios::app);
    log_file << "{\"ts\":\"" << time_buf
             << "\",\"file\":\"DFED_Plugin_Main.cpp\",\"msg\":" << msg
             << "}" << std::endl;
}
/*
...
{
		.version = "1",
		.help = "DFE Detection technique GCC plugin for arm-none-eabi-7.3",
};
...
static void register_attributes(void *event_data, void *data){
    log_with_timestamp(R"JSON({"event":"FUNC_ENTER","file":"/home/nimantha/FIRES/dfed_plugin_instrumented/DFED_Plugin_Main.cpp","function":"register_attributes","func_id":1,"num_params":2,"start_line":47,"end_line":49,"metrics":{"num_params":2,"call_count":1,"has_recursion":false,"has_loop":false,"has_if":false,"has_switch":false,"has_goto":false,"stmt_count":0},"flags":{"is_method":false,"is_static_method":false,"is_const_method":false,"is_virtual_method":false,"is_variadic":false},"params":[{"name":"event_data","type":"void *","is_pointer":true,"is_const":false},{"name":"data","type":"void *","is_pointer":true,"is_const":false}]})JSON");
...
int plugin_init(struct plugin_name_args *info, struct plugin_gcc_version *ver){
    log_with_timestamp(R"JSON({"event":"FUNC_ENTER","file":"/home/nimantha/FIRES/dfed_plugin_instrumented/DFED_Plugin_Main.cpp","function":"plugin_init","func_id":0,"num_params":2,"start_line":53,"end_line":68,"metrics":{"num_params":2,"call_count":1,"has_recursion":false,"has_loop":false,"has_if":true,"has_switch":false,"has_goto":false,"stmt_count":0},"flags":{"is_method":false,"is_static_method":false,"is_const_method":false,"is_virtual_method":false,"is_variadic":false},"params":[{"name":"info","type":"struct plugin_name_args *","is_pointer":true,"is_const":false},{"name":"ver","type":"struct plugin_gcc_version *","is_pointer":true,"is_const":false}]})JSON");
    ...
    log_with_timestamp(R"JSON({"event":"RETURN","function":"plugin_init","func_id":0,"file":"/home/nimantha/FIRES/dfed_plugin_instrumented/DFED_Plugin_Main.cpp","line":55,"ret_type":"int","expr":""})JSON");
    log_with_timestamp(R"JSON({"event":"FUNC_EXIT","function":"plugin_init","func_id":0})JSON");

	struct register_pass_info pass;
	pass.pass = new DFED_PLUGIN(g, info->argv, info->argc);
	pass.reference_pass_name = "*free_cfg";
	pass.ref_pass_instance_number = 1;
	pass.pos_op = PASS_POS_INSERT_BEFORE;

	register_callback("myDFEDPlugin", PLUGIN_PASS_MANAGER_SETUP, NULL, &pass);
	register_callback("myDFEDPlugin", PLUGIN_ATTRIBUTES, register_attributes, NULL);

    log_with_timestamp(R"JSON({"event":"RETURN","function":"plugin_init","func_id":0,"file":"/home/nimantha/FIRES/dfed_plugin_instrumented/DFED_Plugin_Main.cpp","line":67,"ret_type":"int","expr":"0"})JSON");
    log_with_timestamp(R"JSON({"event":"FUNC_EXIT","function":"plugin_init","func_id":0})JSON");
	return 0;
}
