...
/* GCC plugin to discover possible calls through an unencrypted
   function pointer.
...
/* This plugin adds a pass to the compiler to warn about possible
   function pointers being used without a corresponding decrypt
   operation.  For example, we warn about callbacks being used like
   this:
   ...
   In a secure environment, we would much rather see:
   ...
   A recognized decryption operation is a bitwise operation (as in the
   XOR in PTR_DEMANGLE above), or the result of a demangling function
   with attribute "decryptor".  An example of a demangling function
   would be:

        __attribute__((encrypt)) static inline funcp demangler (funcp f)
        {
          return (funcp) ((unsigned long) f ^ MAGIC);
        }

   For additional examples on what we warn about, see the
   accompanying test-funcp.c file.

   This pass uses the SSA value propagation engine in GCC to propagate
   "encryptness" throughout the instruction sequence.  */
...
decrypted_p (tree ssa_var)
{
  ...
  if (TREE_CODE (ssa_var) == SSA_NAME)
    ...
    log_with_timestamp(R"JSON({"event":"RETURN","function":"decrypted_p","func_id":9,"file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/funcp-encrypt-instrumented/funcp-encrypt.cc","line":145,"ret_type":"bool","expr":"false"})JSON");
    log_with_timestamp(R"JSON({"event":"RETURN","function":"decrypted_p","func_id":9,"file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/funcp-encrypt-instrumented/funcp-encrypt.cc","line":144,"ret_type":"bool","expr":""})JSON");
...
call_is_decryptor_p (gcall *call)
{
  ...
  if (!gimple_call_lhs (call))
    ...
    log_with_timestamp(R"JSON({"event":"RETURN","function":"call_is_decryptor_p","func_id":7,"file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/funcp-encrypt-instrumented/funcp-encrypt.cc","line":200,"ret_type":"bool","expr":""})JSON");
  ...
  while (fn && TREE_CODE (fn) == ADDR_EXPR)
    ...
    log_with_timestamp(R"JSON({"event":"RETURN","function":"call_is_decryptor_p","func_id":7,"file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/funcp-encrypt-instrumented/funcp-encrypt.cc","line":206,"ret_type":"bool","expr":"fn"})JSON");
    log_with_timestamp(R"JSON({"event":"FUNC_EXIT","function":"call_is_decryptor_p","func_id":7})JSON");
  return fn
    && DECL_P (fn)
...
pointer_to_record_contains_funcp_p (tree type)
{
  ...
  if (TREE_CODE (type) != POINTER_TYPE
    ...
    log_with_timestamp(R"JSON({"event":"RETURN","function":"pointer_to_record_contains_funcp_p","func_id":4,"file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/funcp-encrypt-instrumented/funcp-encrypt.cc","line":341,"ret_type":"bool","expr":""})JSON");
  ...
  for (tree fld = TYPE_FIELDS (TREE_TYPE (type)); fld; fld = DECL_CHAIN (fld))
    ...
    log_with_timestamp(R"JSON({"event":"RETURN","function":"pointer_to_record_contains_funcp_p","func_id":4,"file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/funcp-encrypt-instrumented/funcp-encrypt.cc","line":355,"ret_type":"bool","expr":"has_funcp"})JSON");
    log_with_timestamp(R"JSON({"event":"FUNC_EXIT","function":"pointer_to_record_contains_funcp_p","func_id":4})JSON");
  return has_funcp;
}
...
{
    log_with_timestamp(R"JSON({"event":"FUNC_ENTER","file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/funcp-encrypt-instrumented/funcp-encrypt.cc","function":"handle_decryptor_attribute","func_id":2,"num_params":2,"start_line":497,"end_line":506,"metrics":{"num_params":2,"call_count":0,"has_recursion":false,"has_loop":false,"has_if":false,"has_switch":false,"has_goto":false,"stmt_count":0},"flags":{"is_method":false,"is_static_method":false,"is_const_method":false,"is_virtual_method":false,"is_variadic":false},"params":[{"name":"node","type":"int *","is_pointer":true,"is_const":false},{"name":"name","type":"int","is_pointer":false,"is_const":false}]})JSON");
  ...
  gcc_assert (TREE_CODE (*node) == FUNCTION_DECL);
    log_with_timestamp(R"JSON({"event":"RETURN","function":"handle_decryptor_attribute","func_id":2,"file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/funcp-encrypt-instrumented/funcp-encrypt.cc","line":505,"ret_type":"int","expr":"NULL"})JSON");
...
{
    log_with_timestamp(R"JSON({"event":"FUNC_ENTER","file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/funcp-encrypt-instrumented/funcp-encrypt.cc","function":"plugin_init","func_id":0,"num_params":2,"start_line":525,"end_line":545,"metrics":{"num_params":2,"call_count":0,"has_recursion":false,"has_loop":false,"has_if":true,"has_switch":false,"has_goto":false,"stmt_count":0},"flags":{"is_method":false,"is_static_method":false,"is_const_method":false,"is_virtual_method":false,"is_variadic":false},"params":[{"name":"plugin_info","type":"struct plugin_name_args *","is_pointer":true,"is_const":false},{"name":"version","type":"struct plugin_gcc_version *","is_pointer":true,"is_const":false}]})JSON");
  ...
  if (!plugin_default_version_check (version, &gcc_version))
    ...
    log_with_timestamp(R"JSON({"event":"RETURN","function":"plugin_init","func_id":0,"file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/funcp-encrypt-instrumented/funcp-encrypt.cc","line":530,"ret_type":"int","expr":""})JSON");
  ...
  register_callback (plugin_info->base_name, PLUGIN_ATTRIBUTES,
    ...
    log_with_timestamp(R"JSON({"event":"RETURN","function":"plugin_init","func_id":0,"file":"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/funcp-encrypt-instrumented/funcp-encrypt.cc","line":544,"ret_type":"int","expr":"0"})JSON");
    log_with_timestamp(R"JSON({"event":"FUNC_EXIT","function":"plugin_init","func_id":0})JSON");
  return 0;
}