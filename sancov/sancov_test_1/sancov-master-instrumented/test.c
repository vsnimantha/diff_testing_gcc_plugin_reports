...
static void log_with_timestamp(const char *msg) {
    ...
    FILE *fp = fopen("/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/sancov-master-instrumented/trace_test.c.log", "a");
    if (fp) {
...
int main(int argc, char *argv[])
{
    ...
    log_with_timestamp("{\"event\":\"RETURN\",\"function\":\"main\",\"func_id\":0,\"file\":\"/home/nimantha/Desktop/KU_Leuven_App_Gen/Experimentation_Program_Gen/Web_Repos/sancov-master-instrumented/test.c\",\"line\":10,\"ret_type\":\"int\",\"expr\":\"argc\"}");
